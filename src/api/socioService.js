...
export const socioService = {
  ...
  async crearSocioCompleto(socioData) {
    try {
      const response = await api.post('/api/socios/crear-completo/', socioData);
      return response.data;
    } catch (error) {
  ...
  async activarDesactivarSocio(id, accion) {
    try {
      const response = await api.post(`/api/socios/${id}/activar-desactivar/`, { accion });
      return response.data;
    } catch (error) {
  ...
  async buscarSociosAvanzado(params = {}) {
    try {
      const response = await api.get('/api/socios/buscar-avanzado/', { params });
      return response.data;
    } catch (error) {
  ...
  async buscarSociosPorCultivo(params = {}) {
    try {
      const response = await api.get('/api/socios/buscar-por-cultivo/', { params });
      return response.data;
    } catch (error) {
  ...
  async validarDatosSocio(params = {}) {
    try {
      const response = await api.get('/api/validar/datos-socio/', { params });
      return response.data;
    } catch (error) {
  ...
  async getParcelasSocio(id) {
    try {
      const response = await api.get(`/api/socios/${id}/parcelas/`);
      return response.data;
    } catch (error) {
  ...
  async getCultivosSocio(id) {
    try {
      const response = await api.get(`/api/socios/${id}/cultivos/`);
      return response.data;
    } catch (error) {
...
export const usuarioService = {
  ...
  async activarDesactivarUsuario(id, accion) {
    try {
      const response = await api.post(`/api/usuarios/${id}/activar-desactivar/`, { accion });
      return response.data;
    } catch (error) {
  ...
  async cambiarPassword(id, nuevaPassword) {
    try {
      const response = await api.post(`/api/usuarios/${id}/cambiar_password/`, {
  ...
  async getRolesUsuario(id) {
    try {
      const response = await api.get(`/api/usuarios/${id}/roles/`);
      return response.data;
    } catch (error) {
...
export const reporteService = {
  ...
  async getReporteUsuariosSocios() {
    try {
      const response = await api.get('/api/reportes/usuarios-socios/');
      return response.data;
    } catch (error) {
